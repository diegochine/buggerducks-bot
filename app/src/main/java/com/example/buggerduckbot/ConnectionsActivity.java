...
import static com.example.buggerduckbot.Constants.TAG;
...
public abstract class ConnectionsActivity extends AppCompatActivity {
    ...
    private final java.util.Map<String, Endpoint> mDiscoveredEndpoints = new HashMap<>();
     ...
     */
    private final java.util.Map<String, Endpoint> mPendingConnections = new HashMap<>();
